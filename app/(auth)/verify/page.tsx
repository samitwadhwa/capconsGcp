          ...
          <Form {...form}>
            <form className="grid gap-2" onSubmit={form.handleSubmit(onSubmit)}>
              ...
              <div className="flex justify-start items-center mt-3">
                <h6 className="text-sm mr-2 text-white">Didn&#39;t get a code?</h6>
                <h6 className="text-[#D6A7FF] text-sm cursor-pointer underline">
                  <Link href="/signup">Resend</Link>
                </h6>
              </div>
              <Button type="submit" className="mt-3 text-foreground font-bold">
                Verify
              </Button>
            </form>
          </Form>
