...
function ForgetPassword() {
  ...
  return (
    <div className="w-full lg:grid lg:min-h-[600px] lg:grid-cols-2 xl:min-h-[800px] mt-4 container mx-auto">
        ...
        <div className="mx-auto grid w-[450px] gap-6">
          <div className="grid gap-2 text-left">
            ...
            <div className="flex space-x-2">
              <p className='text-p font-p text-[#D6A7FF]'> Trouble with logging in?</p>
            </div>
          </div>
          <div className="grid gap-4">
            ...
            <Button type="submit" className="w-full mt-4 border border-[#D6A7FF]  !rounded bg-[#2F2D2D hover:bg-[#D6A7FF]">
              Send OTP
            </Button>
          </div>
      ...
      <span className='mx-2 text-[#A0A0A0] h6 text-sm'>or continue with</span>
      <div className='flex-grow border-t  border-[#A0A0A0]'></div>
      </div>

      <div className="flex space-x-2">
              <p className='text-sm font-p text-[#D6A7FF] underline'><a href="/signup">Sign in with different account?</a></p>
        </div>
