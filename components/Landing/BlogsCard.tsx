...
export default function BlogCard(post: CardProps) {
  return (
    <article className="flex flex-col bg-[#2C2338] hover:bg-foreground-950/60 cursor-pointer transition-all rounded-xl items-start justify-between">
      ...
      <div className="max-w-xl h-full mt-2 flex flex-col justify-between overflow-hidden p-4">
