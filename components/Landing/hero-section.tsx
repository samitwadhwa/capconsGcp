...
const HeroSection = () => {
  return (
    <section className="relative w-full bg-[url(https://storage.googleapis.com/capcons-analytics/Capcons-dev-images/Landing.webp)] bg-cover bg-center bg-no-repeat">
