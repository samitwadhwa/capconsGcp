...
interface CardProps {
  ...
  export default function TabsCard(post: CardProps) {
    ...
    return (
      <article className="flex md:flex-col md:gap-0 flex-row items-center gap-8 bg-[#2C2338] p-5 border border-foreground hover:bg-foreground-950/60 cursor-pointer transition-all rounded-xl items-start justify-between">
        ...
        <div className={`${windowWidth <= 400 ?'max-w-xl md:h-full mt-8 flex flex-col justify-between w-18rem' : 'max-w-xl h-full mt-8 flex flex-col justify-between'}`}>
